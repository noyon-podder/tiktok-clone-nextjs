...
const PostMain = ({ post }: TPostMain) => {
  // when scroll the page and video element will come display. video will play and when scroll to pass video element to video is pause
  ...
  useEffect(() => {
    ...
    if (postMainElement) {
      // create observer for video play and pause
